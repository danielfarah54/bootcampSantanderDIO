...
public class StockService {
    ...
    public StockDTO save(StockDTO dto) {
        ...
        Optional<Stock> optionalStock = repository.findByNameAndDate(
            dto.getName(), dto.getDate());
    ...
    public StockDTO update(StockDTO dto) {
        ...
        Optional<Stock> optionalStock = repository.findByStockUpdate(
            dto.getName(), dto.getDate(), dto.getId());
